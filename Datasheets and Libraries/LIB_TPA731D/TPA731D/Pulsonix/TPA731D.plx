...
//317922/1076823/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TPA731D" (originalName "TPA731D")
	...
	(compDef "TPA731D" (originalName "TPA731D") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "SHUTDOWN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "2" (pinName "BYPASS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "3" (pinName "IN+") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "IN−") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "8" (pinName "VO−") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Output))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "6" (pinName "VDD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "5" (pinName "VO+") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Output))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TPA731D"))
		...
		(attr "Mouser Part Number" "595-TPA731D")
		(attr "Mouser Price/Stock" "https://www.mouser.com/Search/Refine.aspx?Keyword=595-TPA731D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TPA731D")
		(attr "Description" "700-mW Mono, Differential Input, Class-AB Audio Amplifier with Active High Shutdown")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tpa731")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TPA731D.stp")
